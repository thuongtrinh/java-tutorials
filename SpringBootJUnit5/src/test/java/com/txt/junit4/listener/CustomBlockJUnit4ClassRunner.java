package com.txt.junit4.listener;
...
public class CustomBlockJUnit4ClassRunner extends BlockJUnit4ClassRunner {
	...
	public void run(RunNotifier notifier) {
		...
		try {
			// In order capture testRunStarted method at the very beginning of the test run, 
			// we will add below code. Invoke here the run testRunStarted() method
